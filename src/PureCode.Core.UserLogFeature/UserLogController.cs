...
namespace PureCode.Core.Controllers
{
  ...
  public class UserLogController : ControllerBase
  {
    ...
    [HttpGet(Name = "日志列表")]
    public async Task<PagedAjaxResponse<UserLogModel>> IndexAsync(string? query = null, int page = 1, int size = 20)
    {
      var dict = query != null
      ...
      return PagedAjaxResponse<UserLogModel>.Create(list, total, page, size);
    }
  }
}