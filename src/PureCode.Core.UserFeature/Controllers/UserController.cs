...
public partial class UserController : ControllerBase
{
  ...
  public async Task<PagedAjaxResponse<UserModel>> FindUser(string? query = null, int page = 1, int size = 1000)
  {
    ...
    return new PagedAjaxResponse<UserModel>
    {
      Code = 0,
      Total = total,
      Page = page,
  ...
  public async Task<AjaxResponse<UserModel>> GetBriefUserAsync(string userName)
  {
