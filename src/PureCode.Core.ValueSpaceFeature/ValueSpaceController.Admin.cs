...
namespace PureCode.Core.Controllers
{
  public partial class ValueSpaceController
  {
    ...
    public async Task<AjaxResponse<ValueSpaceModel>> UpdateAsync(string name, [FromBody] ValueSpaceModel valueSpace)
    {
    ...
    [Authorize(Policy = PermissionClaimNames.ApiPermission)]
    public PagedAjaxResponse<ValueSpaceModel> Index(int page = 1, int size = 10)
    {
      ...
      return new PagedAjaxResponse<ValueSpaceModel>
      {
        Data = valueSpaces,
